...
import click
import logging
from studsched.app.utils.logging import ColorFormatter, request_msg_format
...
class TestColorFormatter:
    ...
    @mock.patch("studsched.app.utils.logging.click.style",
    ...
    @mock.patch("studsched.app.utils.logging.logging.Formatter")
